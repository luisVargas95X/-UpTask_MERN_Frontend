...
const Busqueda = () => {
    ...
    return (                                        /*after leave hace que se resetie la busqueda y no quede activa al volver abrir bvuscador */
        <Transition.Root show={ buscador } as={Fragment} afterLeave={ () => setBusqueda ('') }>
            <Dialog as="div" className="fixed inset-0 z-10 overflow-y-auto mt-20 p-4 sm:p-20 md:p-20" onClose={ handleBuscador }>
                ...
                <Combobox
                    ...
                    onChange={ (proyecto) => (window.location = `/proyectos/${proyecto._id}`) }//fallos en esta linea, no nos lleva al proyecto inyectado mediante backticks
                >
                    ...
                    {proyectosFiltrados.length > 0 && (
                        <Combobox.Options static className="max-h-72 scroll-py-2
                        overflow-y-auto py-2 text-sm text-gray-800">
