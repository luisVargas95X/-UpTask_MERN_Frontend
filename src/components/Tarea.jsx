  ...
  return (
    <div className="border-b p-5 flex justify-between items-center">
        <div className="flex flex-col items-start">
            ...
            <p className="mb-1 text-sm text-gray500 uppercase">{descripcion}</p>
        ...
        {admin && (
            <button
                ...
                font-bold text-sm rounded-lg hover:bg-sky-600"
                onClick={() => handleModalEditarTarea(tarea)}
            >Editar</button>
        )}
            <button
                className={`${estado ? 'bg-green-600' : 'bg-gray-600'} px-4 py-3
